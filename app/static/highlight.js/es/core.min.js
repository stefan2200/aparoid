...
contains:[w]},v=(e,t,n={})=>{const i=s({scope:"comment",begin:e,end:t,
contains:[]},n);i.contains.push({scope:"doctag",
begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",
end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0})
;const r=p("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/)
;return i.contains.push({begin:f(/[ ]+/,"(",r,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),i
},O=v("//","$"),k=v("/\\*","\\*/"),N=v("#","$");var M=Object.freeze({
...
},COMMENT:v,C_LINE_COMMENT_MODE:O,C_BLOCK_COMMENT_MODE:k,HASH_COMMENT_MODE:N,
...
return t?Number(t):(e=>B.includes(e.toLowerCase()))(e)?0:1}const H={},C=e=>{
...
const t=e[0],i=n.substr(e.index),r=f(k,e,i);if(!r)return q;const s=k
...
;throw e.mode=k,e}if("end"===s.type){const e=b(s);if(e!==q)return e}
...
;const _=X(y);let O="",k=s||_;const N={},M=new g.__emitter(g);(()=>{const e=[]
...
;A=e.index+t}return w(n.substr(A)),M.closeAllNodes(),M.finalize(),O=M.toHTML(),{
...
language:e,value:F(n),illegal:!1,relevance:0,errorRaised:t,_emitter:M,_top:k}
...
console.warn(e)),
g.throwUnescapedHTML))throw new G("One of your code blocks includes unescaped HTML.",e.innerHTML)
