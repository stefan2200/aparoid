...
const a={scope:"keyword",match:/\b(yield|return|let|do|match|use)!/},r={
...
end:/"/,contains:[e.BACKSLASH_ESCAPE]},d={scope:"string",begin:/@"/,end:/"/,
contains:[{match:/""/},e.BACKSLASH_ESCAPE]},p={scope:"subst",begin:/\{/,
end:/\}/,keywords:r},b={scope:"string",begin:/\$"/,end:/"/,contains:[{
match:/\{\{/},{match:/\}\}/},e.BACKSLASH_ESCAPE,p]},g={scope:"string",
begin:/(\$@|@\$)"/,end:/"/,contains:[{match:/\{\{/},{match:/\}\}/},{match:/""/
},e.BACKSLASH_ESCAPE,p]},m={scope:"string",begin:/\$"""/,end:/"""/,contains:[{
match:/\{\{/},{match:/\}\}/},p],relevance:2},_={scope:"string",
match:t(/'/,i(/[^\\']/,/\\(?:.|\d{3}|x[a-fA-F\d]{2}|u[a-fA-F\d]{4}|U[a-fA-F\d]{8})/),/'/)
};return p.contains=[g,b,d,u,_,a,s,c,l,f,o],{name:"F#",aliases:["fs","f#"],
keywords:r,illegal:/\/\*/,classNameAliases:{"computation-expression":"keyword"},
contains:[a,{variants:[m,g,b,{scope:"string",begin:/"""/,end:/"""/,relevance:2
},d,u,_]},s,{begin:[/type/,/\s+/,e.UNDERSCORE_IDENT_RE],beginScope:{1:"keyword",
3:"title.class"},end:n(/\(|=|$/),contains:[o]},{scope:"meta",begin:/^\s*\[</,
excludeBegin:!0,end:n(/>\]/),relevance:2,contains:[{scope:"string",begin:/"/,
end:/"/},f]},c,l,f,o]}}})();export default hljsGrammar;